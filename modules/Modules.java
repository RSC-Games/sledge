...
public class Modules {
    ...
    public static int tryRun(String name, String argString) {
        switch (name) {
            ...
            case "javac_v8": {
                LogModule.warn("module_ldr", "Deprecated module: jcompv8.");
            ...
            case "use_launcher": {
                LogModule.warn("module_ldr", "Moving javac_jdk8 and module_ldr into a custom module!");
                return JavaCompileSystem.injectLoader(env, argString);
            } 
            // Copy the generated application into the jbuilder folder.
            case "cpsledge": {
                LogModule.warn("module_ldr", "Development only!");
            ...
            case "log": {
                LogModule.log("userlog", argString);
                return 0;
            }
            case "warn": {
